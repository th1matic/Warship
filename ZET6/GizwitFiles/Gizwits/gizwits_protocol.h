...
* @{
*/
#define PRODUCT_KEY "9ef2a25d1c5c47b59fc9ce37014d450d"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "c5f7ef6778154f7091947095365af071"
...
#define doctor_beat_RATIO                         1
#define doctor_beat_ADDITION                      0
#define doctor_beat_MIN                           0
#define doctor_beat_MAX                           200
#define doctor_weight_RATIO                         0.01
#define doctor_weight_ADDITION                      0
#define doctor_weight_MIN                           0
#define doctor_weight_MAX                           50000
#define doctor_height_RATIO                         0.01
#define doctor_height_ADDITION                      0
#define doctor_height_MIN                           0
#define doctor_height_MAX                           20000
#define doctor_stress_RATIO                         0.01
#define doctor_stress_ADDITION                      0
#define doctor_stress_MIN                           0
#define doctor_stress_MAX                           30000
/**@} */
...
typedef struct {
  uint32_t valuedoctor_beat;
  float valuedoctor_weight;
  float valuedoctor_height;
  float valuedoctor_stress;
} dataPoint_t;
...
typedef struct {
  uint8_t valuedoctor_beat;
  uint16_t valuedoctor_weight;
  uint16_t valuedoctor_height;
  uint16_t valuedoctor_stress;
} devStatus_t; 
